...
{
    public static class UpdateMembroCommand
    {
        public sealed record Command(int Id, string Nome, DateTime DataDeNascimento, Sexo Sexo, string RG, string CPF,
           ...
           string NomeDoPastorAnterior, Funcao Funcao, Status Status, string Foto) : IRequest<MembroViewModel>;
